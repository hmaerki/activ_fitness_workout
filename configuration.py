...
WHO_SANDRA = Who(
    ...
    workout_template={
        "D2": {"weight": 12.5, "set1": 16, "set2": 16},
        "F1": {"weight": 7.5, "set1": 15, "set2": 15},
        "E1": {"weight": 54.5, "set1": 16, "set2": 16},
        "E2": {"weight": 38.3, "set1": 16, "set2": 16},
        "B5": {"weight": 27.5, "set1": 18, "set2": 18},
        "H2": {"weight": 9.0, "set1": 18, "set2": 18},
        "Mitte1": {"weight": 3.0, "set1": 17, "set2": 17},
        "Mitte2": {"weight": 3.0, "set1": 16, "set2": 16},
        "C1": {"weight": 30.0, "set1": 18, "set2": 18},
        "A5": {"weight": 17.5, "set1": 17, "set2": 17},
